...
(defun print-usage ()
  ...
  (format t "  -O               Enable full optimization (function inlining)~%")
  (format t "  --peephole       Enable peephole optimization~%")
  (format t "  --no-size-opt    Disable size optimization (inline mul/div/mod)~%")
  ...
  (format t "  lrcc -O --peephole -r hello.c # Full optimization and run~%"))
